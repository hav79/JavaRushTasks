...
public class Solution {
    ...
    public static void main(String[] args) throws IOException {
        ...
        ReaderThread consolReader4 = new ReaderThread();
        ReaderThread consolReader5 = new ReaderThread();
        ...
        consolReader4.interrupt();
        consolReader5.interrupt();
        System.out.println("#1:" + consolReader1);
        System.out.println("#2:" + consolReader2);
        System.out.println("#3:" + consolReader3);
        System.out.println("#4:" + consolReader3);
        System.out.println("#5:" + consolReader3);
